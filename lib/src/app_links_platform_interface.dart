...
abstract class AppLinksPlatform extends PlatformInterface {
  ...
  // Gets the initial / first link
  Future<Map<String, dynamic>?> getInitialReferrerURL() => throw UnimplementedError(
    'getInitialReferrerURL() not implemented on the current platform.',
  );
  // 从原生（iOS）接收到的 Event 事件
  Stream<Map<String, dynamic>> get referrerURLStream => throw UnimplementedError(
      'referrerURLStream not implemented on the current platform.');
  // 整合 getInitialReferrerURL &  referrerURLStream
  Stream<Map<String, dynamic>> get allReferrerURLStream => throw UnimplementedError(
      'allReferrerURLStream not implemented on the current platform.');
