...
public class AppLinksPlugin implements
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    ...
    } else if (call.method.equals("getInitialReferrerURL")) {
      Map<String, String> parameters = new HashMap<String, String>();
      parameters.put("link", latestLink);
      parameters.put("referrerURL", referrerURLStr);
  ...
  private boolean handleIntent(Intent intent) {
    ...
    String referrer = AppLinksHelper.getReferrer(intent);
    if (referrer != null) {
      referrerURLStr = referrer;
    }
...
//      if (eventSink != null) eventSink.success(dataString);
      if (eventSink != null) eventSink.success(parameters);
      return true;
    }
